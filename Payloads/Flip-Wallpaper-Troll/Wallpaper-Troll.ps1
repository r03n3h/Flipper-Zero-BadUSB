############################################################################################################################################################                      
#                                  |          		 		   ___T_									   #                                 
# Title        : Wallpaper-Troll   |           ___ _____		  | 0 0 |									   #           
# Author       : r03n              |  	 _ __ / _ \___ / _ __		  |__o__|									   #           
# Original by  : Jakobi            | 	| '__| | | ||_ \| '_ \ 		o==|ooo|==o									   #
# Version      : 1.1               | 	| |  | |_| |__) | | | |		   |___|									   #
# Category     : Awerness          |	|_|   \___/____/|_| |_|		   /| |\									   #     
# Target       : Windows 10,11     | 					  [_] [_]									   #             
# Mode         : HID               | 															   #
#                                  | 															   #
############################################################################################################################################################
